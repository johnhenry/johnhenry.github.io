...
globalThis.customElements.define("menu-component", MenuComponent);

<Meta title="JS Components/Menu/Demo" />

# Menu Component

<Preview>
  <Story name="Sample Menu">
    {() => html` <menu-component class="menu" id="menu">
